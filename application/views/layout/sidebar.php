<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href="<?= base_url('dashboard') ?>">
      <img src="<?= base_url('') ?>/assets/img/icon.jpg" class="navbar-brand-img h-100 rounded-circle" alt="main_logo">
      <span class="ms-1 font-weight-bold">Sertifikat</span>
    </a>
  </div>
  ...
  <div class="collapse navbar-collapse w-auto " id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link <?= ($title === "Sertifikat asli") ? 'active' : '' ?>" href="<?= base_url('sertifikat') ?>">
          <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            <i class="ni ni-single-02 text-primary text-sm opacity-10"></i>
          </div>
          <span class="nav-link-text ms-1">Sertifikat asli</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link <?= ($title === "Sertifikat") ? 'active' : '' ?>" href="<?= base_url('penyakit') ?>">
          <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <!-- <li class="nav-item">
        <a class="nav-link <?= ($title === "Gejala") ? 'active' : '' ?>" href="<?= base_url('gejala') ?>">
          <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <!-- <li class="nav-item">
        <a class="nav-link <?= ($title === "Diagnosa") ? 'active' : '' ?>" href="<?= base_url('diagnosa') ?>">
          <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
